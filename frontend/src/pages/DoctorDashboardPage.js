...
const getAmountPaid = (appointment) => {
  ...
  const completedPayment = payments.find(payment => (
    payment.payment_status === 'completed' || payment.paymentStatus === 'completed'
  ));
...
const getPaymentSummary = (appointment) => {
  ...
  return {
    ...
    reference: payment.bank_transaction_reference || payment.transaction_id || '',
  ...
  return (
    <div className="dashboard-page doctor-dashboard">
      <div className="dashboard-heading-row">
        ...
        <Link to="/doctor/availability" className="action-btn compact">Manage Availability</Link>
      </div>
                  ...
                  return (
                    <tr key={id}>
                      ...
                      <td className="table-actions">
                        <Link to={`/doctor/appointments/${id}`} className="small-link">Details</Link>
